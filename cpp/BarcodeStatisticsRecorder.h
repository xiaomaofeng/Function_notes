...
public:
	...
	typedef struct _tagRunningTraceInfo
	{
		string SCAN_DIRECTORY; //DOCUMENT_PATH;
		string CURRENT_FILE_PATH;
		string CURRENT_FILE_STATE;
		string BCODE_READER;
		...
		_tagRunningTraceInfo()
		{
			...
			BCODE_READER = "";
			LAST_FILE_PATH = "";
			CURRENT_FILE_STATE = "STATE_INVALID";
		}
	}RUNNING_TRACE_INFO;
private:
...
private:
	...
	void OutputDecodeResult(DecodeResultInfo *resultMode);
